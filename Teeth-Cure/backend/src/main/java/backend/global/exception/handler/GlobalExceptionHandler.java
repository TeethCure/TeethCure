package backend.global.exception.handler;

import backend.global.exception.GlobalException;
import backend.global.exception.errorcode.ExceptionCode;
import backend.global.exception.errorcode.InternalServerExceptionCode;
import backend.global.exception.response.ExceptionResponse;
import backend.global.exception.response.MethodArgumentExceptionResponse;
